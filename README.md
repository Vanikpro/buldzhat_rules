...
4. Модератор не имеет права оскорблять Вас в любых переписках, даже в ЛС.
...
# 9. Оповещения о модификации правил
...
4. У нашего сервера также есть [Вики](https://wiki.2buldzha2t.ru), которая посвященна истории сервера, его игрокам, их постройкам и событиям.
